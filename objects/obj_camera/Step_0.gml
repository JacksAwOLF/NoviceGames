...
if mouse_check_button(mb_right)
{
	...
	var newx = camera_get_view_x(current_camera) + mouse_xstart - mouse_x;
	var newy = camera_get_view_y(current_camera) + mouse_ystart - mouse_y;
...
if mouse_wheel_up()
{
	...
	var prev_view_h = camera_get_view_height(current_camera); //view_hview;
	...
	var neww = prev_view_w - window_max_w/zoom_speed;
	var newh = prev_view_h - window_max_h/zoom_speed;
	...
	var newx = camera_get_view_x(current_camera) + abs(neww-prev_view_w)/2;
	var newy = camera_get_view_y(current_camera) + abs(newh-prev_view_h)/2;
